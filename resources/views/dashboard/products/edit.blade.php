<form method="POST" action="{{ route('products.update', [$product]) }}" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="price" class="form-control" id="price" value="{{$product->price}}" name="price"
                placeholder="Enter Product price">
        </div>
        <div class="form-group">
            <label for="origin">Origin</label>
            <input type="origin" class="form-control" id="origin" value="{{$product->origin}}" name="origin"
                placeholder="Enter Product origin">
        </div>

        <div class="form-group">
            <label for="membrane">Membrane</label>
            <input type="membrane" class="form-control" id="membrane" value="{{$product->membrane}}" name="membrane"
                placeholder="Enter Product membrane">
        </div>

        <div class="form-group">
            <label for="capacity">Capacity</label>
            <input type="capacity" class="form-control" id="capacity" value="{{$product->capacity}}" name="capacity"
                placeholder="Enter Product capacity">
        </div>

        <div class="form-group">
            <label for="dimension">Dimension</label>
            <input type="dimension" class="form-control" id="dimension" value="{{$product->dimension}}" name="dimension"
                placeholder="Enter Product dimension">
        </div>

        <div class="form-group">
            <label for="technology">Technology</label>
            <input type="technology" class="form-control" id="technology" value="{{$product->technology}}"
                name="technology" placeholder="Enter Product technology">
        </div>

        <div class="form-group">
            <label for="warranty">Warranty</label>
            <input type="warranty" class="form-control" id="warranty" value="{{$product->warranty}}" name="warranty"
